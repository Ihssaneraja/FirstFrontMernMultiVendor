...
const Card = () => {
    ...
    return (
        <div>
           <Header/>
           <section className=' font-satoshi bg-[url("http://localhost:3000/images/banner/shop.png")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
            <div  className='absolute left-0 top-0 w-full h-[12rem]' style={{
    backgroundImage: 'url(/public/carda.jpg)',
    backgroundSize: 'cover',
    backgroundPosition: 'center',
    
  }} >
                <div className='w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto'>
                    <div className=' flex flex-col justify-center gap-1 items-center h-full w-full text-black font-bold'>
                    <div className="glitch font-satoshi" data-text="CARDPAGE">CARDPAGE<h2 className='  glitch data-text="CardPage" text-3xl font-bold'></h2></div> 
                ...
                <div className='w-[67%] md-lg:w-full'>
                    <div className='pr-3 md-lg:pr-0'>
                        <div className='flex flex-col gap-3'>
                            <div className='bg-[#dbdbdb] p-4'>
                    <h2 className='text-md text-gray-500 font-semibold'>Stock Products {card_products.length}</h2>
                            </div>

                {
                   card_products.map((p,i) => <div className='flex bg-[#dbdbdb] p-4 flex-col gap-2'>
   ...
   <div className='flex justify-between w-5/12 sm:w-full sm:mt-3'>
       ...
       <div className='flex gap-2 flex-col'>
           ...
           <button onClick={() => dispatch(delete_card_product(pt._id)) } className='px-5 py-[3px] bg-[#6d6a6a] text-white'>Delete</button>
       </div>
   </div>
...
<div className='  w-[33%] md-lg:w-full'>
    <div className=' pl-3 md-lg:pl-0 md-lg:mt-5'>
        {
            card_products.length > 0 && <div className='bg-[#dbdbdb] p-3 text-slate-600 flex flex-col gap-3'>
                ...
                <input className='w-full px-3 py-2 border border-gray-200 outline-0 focus:border-gray-500 rounded-sm' type="text" placeholder='Input Vauchar Coupon' />
                <button className=' font-satoshi px-5 py-[1px] bg-[#6d6a6a] text-white rounded-sm uppercase text-sm'>Apply</button>
                </div>

                <div className='flex justify-between items-center'>
                    <span>Total</span>
                    <span className='text-lg text-gray-600'>${price + shipping_fee} </span>
                </div>
                <button onClick={redirect} className='px-5 py-[6px] rounded-sm hover:shadow-gray-500/50 hover:shadow-lg bg-[#6d6a6a] text-sm text-white uppercase '>
