...
import './shpiingCSS/shipping.css'
...
const Shipping = () => {
    ...
    backgroundImage: 'url(/public/shop.jpg)',
    ...
    height:'12.5rem'
                ...
                <h2  aria-hidden="true"  className='glitchF  text-7xl font-bold text-center text-gray-300  py-5'>shipping page  </h2>
                <div className='flex font-bold text-black justify-center items-center gap-2 text-3xl w-full'>
                        <Link to='/'>Home</Link>
                        <span className='pt-1'>
                        <IoIosArrowForward />
                        </span>
        ...
        <div className='w-[85%] lg:w-[90%] md:w-[90%] sm:w-[90%] mx-auto py-16'>
           <div className='w-full flex flex-wrap'>
            ...
            <div className='flex flex-col gap-1 mt-7 mb-2 w-full'>
               <button className='px-3 py-[6px] rounded-sm hover:shadow-gray-500/50 hover:shadow-lg bg-[#605d5d] text-white'>Save Change </button>
            </div> 
            </div> 
                </form>
...

            {
                ...
                <p className='text-slate-600 text-sm' >Email To rajae@gmail.com</p>
              ...
              {
                   products.map((p,i) => <div key={i} className='flex bg-[#ebebeb] p-4 flex-col gap-2'>
   ...
   <div className='flex justify-between w-5/12 sm:w-full sm:mt-3'>
    ...
    <div className='pl-3 md-lg:pl-0 md-lg:mt-5'>
            ...
            <div className='shadow-md p-3 text-slate-600 flex flex-col gap-3'>
                <h2 className='text-xl font-bold rounded-md'>Order Summary</h2>
                ...
                <button onClick={placeOrder} disabled={res ? false : true} className={`px-5 py-[6px] rounded-sm hover:shadow-gray-500/50 hover:shadow-lg ${res ? 'bg-[#605d5d]' : 'bg-[#605d5d]'}  text-sm text-white uppercase`}>
                   Place Order 
                </button>
