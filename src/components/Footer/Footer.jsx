...
const Footer = () => {
    ...
    const {userInfo} = true
    const {card_product_count,wishlist_count} = true

    return (
        <footer className='bg-transparent font-satoshi'>
            ...
            <div className='w-4/12 lg:w-full lg:mt-6'>
                <div className='w-full flex flex-col justify-start gap-5'>
                    ...
                    <div className='h-[50px] w-full bg-white border   relative'>
                        <input className='h-full bg-[#f5f5f5] w-full px-3 outline-0 ' type="text" placeholder='Enter Your Email' />
                        <button className='h-full absolute right-0 bg-[#6d6a6a] text-white uppercase px-4 font-bold text-sm'>Subscribe</button>  
                     </div> 
                     <ul className='flex justify-start items-center gap-3'>
                        <li>
                            <a className='w-[38px] h-[38px] text-gray-500 hover:bg-[#e0d9d9] hover:text-white flex justify-center items-center bg-white rounded-full' href="#"><FaFacebookF/> </a>
                        </li>

                        <li>
                            <a className='w-[38px] h-[38px] text-gray-500 hover:bg-[#e0d9d9] hover:text-white flex justify-center items-center bg-white rounded-full' href="#"><FaTwitter/> </a>
                        </li>
                        <li>
                            <a className='w-[38px] h-[38px]  text-gray-500 hover:bg-[#e0d9d9] hover:text-white flex justify-center items-center bg-white rounded-full' href="#"><FaLinkedin/> </a>
                        </li>
                        <li>
                            <a className='w-[38px] h-[38px] text-gray-500  hover:bg-[#e0d9d9] hover:text-white flex justify-center items-center bg-white rounded-full' href="#"><FaGithub/> </a>
                        </li>
