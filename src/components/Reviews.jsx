    ...
    <div> 
        {
            userInfo ? <div className='flex flex-col gap-3'>
                <div className='flex gap-1'>
                    ...
                    fullSymbol={<span className='text-slate-600 text-4xl'><FaStar/></span>} 
                    /> 
                 </div> 
                 <form onSubmit={review_submit}>
                    <textarea value={re} onChange={(e) => setRe(e.target.value)} required className='border outline-0 p-3 w-full text-slate-600' name="" id="" cols="30" rows="5"></textarea>
                <div className='mt-2'>
            <button className='py-1 px-5 bg-gray-600 text-white rounded-sm'>Submit</button>
                </div> 
                ...
                <Link to='/login' className='py-2 px-5 bg-[#444444] text-white rounded-sm'> Login First </Link>
            </div>
        }
    </div>
